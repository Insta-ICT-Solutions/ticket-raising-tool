...
// // import { db } from '../../../firebase/firebaseconfig'; // Adjust relative path accordingly
...
// //     let serialNumber = 1; // Default to 1
// //     if (counterDoc.exists()) {
// //       const data = counterDoc.data();
// //       if (data.year === currentYear && data.month === currentMonth) {
// //         serialNumber = data.lastUsed + 1; // Increment last used number
// //       }
// //     }
...
// //     try {
// //       const ticketID = await generateTicketID(); // Get incremental ticket ID
